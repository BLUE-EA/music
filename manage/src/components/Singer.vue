  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        <el-button class="handle-del mr10" type="danger" size="mini" @click="delAll">批量删除</el-button>
        <el-button type="primary" size="mini" @click="centerDialogVisible = true">添加歌手</el-button>
        <el-input v-model="select_word" class="handle-input mr10" style="float: right;margin-right: 10%" size="mini"
                  placeholder="筛选关键词"></el-input>
      </div>
      <el-table ref="multipleTable" size="mini" border style="width: 100%" height="730px" :data="data"
        ...
        <el-table-column label="简介">
          <template slot-scope="scope">
            <p class="scroll" style="height: 100px; overflow: scroll">{{ scope.row.introduction }}</p>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      addsinger() {
        ...
        params.append('pic', '/img/imgHead.png')
