<template>
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb style="font-size: 20px;margin-left: 20px;margin-top: 10px;" separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-headset"></i> {{singerName}}--歌曲信息
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="select_word" style="float: right; margin-right: 20px" size="mini" placeholder="筛选关键词"
                  class="handle-input mr10"></el-input>
      </div>
      <el-table :data="data" size="mini" border style="width: 100%;overflow-y: scroll" ref="multipleTable"
                height="723px"
