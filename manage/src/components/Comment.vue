<template>
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb style="font-size: 20px;margin: 10px;" separator="/">
        <el-breadcrumb-item>
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <el-input v-model="select_word" size="mini" style="float: right;margin-right: 10%" placeholder="筛选关键词"
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.tempDate = []
        // let promise
        if (this.$route.query.type === "0") {  //从歌曲页面传过来
          getCommentOfSongId(this.$route.query.id)
            .then(res => {
              for (let item of res) {
                this.getUsers(item.fatherComment.userId, item)
              }
            })
